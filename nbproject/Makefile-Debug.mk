...
${OBJECTDIR}/BaseEvent.o: BaseEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseEvent.o BaseEvent.cpp

${OBJECTDIR}/BaseObject.o: BaseObject.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseObject.o BaseObject.cpp

${OBJECTDIR}/EventTypeGuard.o: EventTypeGuard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EventTypeGuard.o EventTypeGuard.cpp

${OBJECTDIR}/MyAction.o: MyAction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyAction.o MyAction.cpp

${OBJECTDIR}/MyGuard.o: MyGuard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyGuard.o MyGuard.cpp

${OBJECTDIR}/MyState.o: MyState.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyState.o MyState.cpp
...
${OBJECTDIR}/testStateMachine.o: testStateMachine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testStateMachine.o testStateMachine.cpp
...
${TESTDIR}/tests/TestBaseEvent.o: tests/TestBaseEvent.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestBaseEvent.o tests/TestBaseEvent.cpp


${TESTDIR}/tests/mainBaseEvent.o: tests/mainBaseEvent.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/mainBaseEvent.o tests/mainBaseEvent.cpp


${TESTDIR}/tests/TestState.o: tests/TestState.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -I. -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestState.o tests/TestState.cpp


${TESTDIR}/tests/mainState.o: tests/mainState.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -I. -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/mainState.o tests/mainState.cpp


${TESTDIR}/tests/TestStateMachineUnit.o: tests/TestStateMachineUnit.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestStateMachineUnit.o tests/TestStateMachineUnit.cpp


${TESTDIR}/tests/mainStateMachine.o: tests/mainStateMachine.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/mainStateMachine.o tests/mainStateMachine.cpp


${TESTDIR}/tests/TestTransition.o: tests/TestTransition.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestTransition.o tests/TestTransition.cpp


${TESTDIR}/tests/mainTransition.o: tests/mainTransition.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -I. -I. -I. -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/mainTransition.o tests/mainTransition.cpp
...
${OBJECTDIR}/BaseEvent_nomain.o: ${OBJECTDIR}/BaseEvent.o BaseEvent.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseEvent_nomain.o BaseEvent.cpp;\
	else  \
...
${OBJECTDIR}/BaseObject_nomain.o: ${OBJECTDIR}/BaseObject.o BaseObject.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BaseObject_nomain.o BaseObject.cpp;\
	else  \
...
${OBJECTDIR}/EventTypeGuard_nomain.o: ${OBJECTDIR}/EventTypeGuard.o EventTypeGuard.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EventTypeGuard_nomain.o EventTypeGuard.cpp;\
	else  \
...
${OBJECTDIR}/MyAction_nomain.o: ${OBJECTDIR}/MyAction.o MyAction.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyAction_nomain.o MyAction.cpp;\
	else  \
...
${OBJECTDIR}/MyGuard_nomain.o: ${OBJECTDIR}/MyGuard.o MyGuard.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyGuard_nomain.o MyGuard.cpp;\
	else  \
...
${OBJECTDIR}/MyState_nomain.o: ${OBJECTDIR}/MyState.o MyState.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyState_nomain.o MyState.cpp;\
	else  \
...
${OBJECTDIR}/testStateMachine_nomain.o: ${OBJECTDIR}/testStateMachine.o testStateMachine.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/testStateMachine_nomain.o testStateMachine.cpp;\
	else  \
